...
if (!isset($_SESSION["sysApp_autenticado"]) || $_SESSION["sysApp_autenticado"] != "SI")
{ 
...
else 
{
  ...
  $fechaGuardada = $_SESSION["sysApp_ultimoAcceso"];
  ...
  if($tiempo_transcurrido >= $seg_sesion)//30 segundos 
	...
	{
    $_SESSION["sysApp_ultimoAcceso"] = $ahora; 
    //se manda llamar la conexion
    include "datos_usuario_acceso.php";

    if ($acceso_modulo != 1) {
        echo"<script language=\"javascript\">window.location=\"../mPanelControl/index.php\"</script>";
    }else{
