<?php 
	...
	$id_usuario = $_SESSION["sysApp_id_usuario"];
	$nombre_persona = $_SESSION["sysApp_persona"];
	$fechaAlta_usuario = $_SESSION["sysApp_fechaAlta"];
	$perfil_usuario = $_SESSION["sysApp_perfil"];
	$nombre_perfil = $_SESSION["sysApp_nombre_perfil"];
	$id_persona = $_SESSION["sysApp_id_persona"];
	...
	$cadena = "SELECT modulos.id, modulos.nombre 
				FROM modulos 
